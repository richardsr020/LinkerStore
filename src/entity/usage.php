...
class User extends DatabaseConnection {
     ...
     */
    public function createUser($email, $phone, $password, $firstName, $lastName) {
        try {
            $hashedPassword = password_hash($password, PASSWORD_BCRYPT);
            $stmt = $this->pdo->prepare("INSERT INTO user (email, phone, password, first_name, last_name) VALUES (:email, :phone, :password, :first_name, :last_name)");
            $stmt->execute([
                ':email' => $email,
                ':phone' => $phone,
